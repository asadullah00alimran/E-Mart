...
class VisitorController extends Controller
{
    ...
    public function CategoryProducts(Request $data){
        $products = DB::table('products')->where('product_delete',1)->where('category_id',$data->category_id)->get();
        return view('visitors.category_product',compact('products'));
    }
    public function SubcategoryProducts(Request $data){
        $products = DB::table('products')->where('product_delete',1)->where('category_id',$data->category_id)->where('sub_category_id',$data->sub_category_id)->get();
    ...
    public function Exchange(){
        $exchanges = DB::table('exchanges')->where('exchanger_id',Session::get('LoggedUser')->id)->orderBy('exc_id','DESC')->get();
