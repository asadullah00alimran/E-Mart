...
<div class="container-fluid pt-5" >
    <div class="row px-xl-5 col-10 mx-auto pb-4" >
        ...
        <div class="col-lg-7 mb-5 mx-auto pb-4" style="box-shadow: 0px 0px 5px green;background:#B8FFF9">
            ...
            <div class="contact-form">
                <form method="POST" action="{{ route('visitor_register') }}">
                    ...
                    <div>
                        <button class="btn btn-outline-dark py-2 px-4 mt-4 float-right form-control" type="submit" >SignUp</button>
                    </div>
                </form>
            </div>
        </div>
