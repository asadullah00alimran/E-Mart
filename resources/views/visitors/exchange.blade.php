...
<div class="modal fade" id="staticBackdrop" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  ...
  @endphp
            @if ($check==NULL || $check->exchange_status=='Completed' || $check->exchange_status=='Cancel')
...
<div class="modal fade" id="staticBackdropp{{$exchange->exc_id}}" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="staticBackdropLabel">Cancel Reason #{{$exchange->exc_id+100}}</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
                ...
                <div class="col-12 text-center text-danger">
                    ...
                    <tr>
                        ...
                        <td class="text-center" style="width: 20%">
                            ...
                            @if ($exchange->exchange_status=='Cancel')
                                <button class="btn btn-danger p-1 rounded" data-toggle="modal" data-target="#staticBackdropp{{$exchange->exc_id}}">Reason</button>
                            @endif
                        </td>
                        <td class="text-center">
