...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" href="{{asset('logos/1663142662.png')}}" />
</head>
<body class="sidebar-fixed sidebar-dark" style="color: green">
        ...
        <footer class="footer">
            <div class="container-fluid clearfix">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © @php  $date = \Carbon\Carbon::now();
                ...
                echo($formatedDate); @endphp<a href="#"> <i class="fa fa-free-code-camp text-danger"></i> E-Mart</a>. All rights reserved.</span>
